...
| [`drivers/`](drivers/README.md) | unmodified drivers for the real chip, from two independent families.  They keep their own licences; nothing in `src/` or `tb/` is derived from them |
